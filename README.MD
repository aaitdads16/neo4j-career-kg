...
The graph links Job nodes to Company, Location, and Skill nodes via typed 
relationships (OFFERED_BY, IN_LOCATION, REQUIRES_SKILL), enabling cross-entity 
analytics impossible in a flat relational schema.
